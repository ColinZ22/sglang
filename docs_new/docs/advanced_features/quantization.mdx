...
SGLang running on AMD GPUs (gfx95x+) supports `--quantization quark_mxfp4`, which quantizes BF16/FP8/NVFP4 model weights to MXFP4 at load time, with dynamic MXFP4 quantization for activations and MXFP4 GEMMs.
