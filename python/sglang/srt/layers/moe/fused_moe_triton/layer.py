...
class FusedMoE(torch.nn.Module):
    ...
    def __init__(
        ...
        # The Marlin and NVFP4 emulation backends run the standard Triton
        # fused-MoE runner, which applies routed_scaling_factor itself in the
        # combine step. So they must NOT fuse routed scaling into topk.
